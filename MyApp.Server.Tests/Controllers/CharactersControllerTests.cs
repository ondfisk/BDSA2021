...
public class CharactersControllerTests
{
    ...
    public async Task Create_creates_Character()
    {
        ...
        var created = new CharacterDetailsDto(1, "Superman", "Clark", "Kent", "Metropolis", Male, 1938, "Reporter", "http://localhost/superman.jpg", new HashSet<string>());
    ...
    public async Task Get_given_existing_returns_character()
    {
        ...
        var logger = new Mock<ILogger<CharactersController>>();
        var repository = new Mock<ICharacterRepository>();
        var character = new CharacterDetailsDto(1, "Superman", "Clark", "Kent", "Metropolis", Male, 1938, "Reporter", "http://localhost/superman.jpg", new HashSet<string>());
